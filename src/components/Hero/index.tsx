    ...
    <div className="relative w-full bg-very-light-gray flex flex-col md:flex-row-reverse md:items-center pb-12">
      <div className="relative w-full">
        <div className="block md:hidden w-full relative">
          <Image src={bg_mobile} alt="" className="w-full h-auto" />
          <div className="absolute inset-0 flex justify-center items-center">
            <Image src={mockups} alt="" className="h-full w-auto z-10" />
          </div>
        </div>
        <div className="hidden md:block relative">
          <Image src={bg_desktop} alt="" className="w-full h-auto" />
          <Image src={mockups} alt="" className="absolute top-0 left-0 z-10" />
        </div>
      </div>

      <div className="flex flex-col px-9 md:px-20 gap-5 md:items-start">
        <h1 className="text-bold text-center md:text-left text-5xl md:text-7xl text-dark-blue">
